...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-4">
                    <form action="{{ route('admin.gajikaryawan.index') }}" method="get">
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <a href="{{ route('admin.gajikaryawan.cetak',[ltrim(date('m'), '0'),date('Y')]) }}" class="btn btn-info"> Cetak <i class="fa fa-print"></i> </a>
                        @else
                        <a href="{{ route('admin.gajikaryawan.cetak',[request()->get('bulan'),request()->get('tahun')]) }}" class="btn btn-info"> Cetak <i class="fa fa-print"></i> </a>
                        @endif
                    </form>
                </div>
            </div>
